...
PARAM_DEFINE PARAM_REDUCTIONS_PARAM1 = 2081;
//
// futility pruning
//
...
// Stocfish 14での値31。Stockfish 16での値26。
// 重要度　★★★★☆
// 元の値 = 26 , step = 2
// [PARAM] min:15,max:50,step:2,interval:1,time_rate:1,fixed
PARAM_DEFINE PARAM_FUTILITY_AT_PARENT_NODE_GAMMA1 = 31;
...
PARAM_DEFINE PARAM_UPDATE_ALL_STATS_EVAL_TH = 145;
