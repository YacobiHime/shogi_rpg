...
### ShogiHome 1.28.0由来の対局UI

- 種別: 再利用用対局UIコード
- 入手元: https://github.com/sunfish-shogi/shogihome
- 制作者: Kubo Ryosuke および貢献者
- ライセンス: MIT
- 使用箇所: `shogi-match-ui/src/renderer/view/primitive/`、`src/board-ui/vendor/shogi-match-ui.js`
- 著作権表示: Copyright (c) 2022 Kubo Ryosuke
- 備考: 盤面、駒台、成り選択、直前手表示、候補手矢印を切り出し、SFEN入力・USI出力のWeb Componentとして実装。RPG固有のエンジン、セーブ、進行データは含めない。MITライセンス全文は`shogi-match-ui/NOTICE.md`に同梱する。

### shogi-images

- 種別: 将棋駒画像
- 入手元: https://sunfish-shogi.github.io/shogi-images/
- 制作者: sunfish-shogi
- ライセンス: CC0 1.0
- 使用箇所: `shogi-match-ui/public/`、`assets/shogihome/`
- 配布方法: COEP環境でも表示できるよう同一オリジンから自己ホスト
- 表記要否: 不要
